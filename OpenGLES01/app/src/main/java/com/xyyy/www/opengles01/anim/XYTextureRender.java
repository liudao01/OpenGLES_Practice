...
import com.xyyy.www.opengles01.image.FboRender;
...
//        5、解绑VBO
        ...
        imageTextureId2 = loadTexture(R.drawable.img_1);
        srcImg = R.drawable.img_1;
...
//        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);//0的话就是不使用离屏渲染
        ...
        imageTextureId2 = XYShaderUtil.loadTexrute(srcImg, context);
        //绘制第二张图片
        ...
        int[] ids = new int[]{imageTextureId2};
